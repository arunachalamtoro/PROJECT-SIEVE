...
import { estimateTokens, calculateCost, type SifthookdevConfig, type TokenUsage } from '../types.js';
...
export function formatBudgetError(check: BudgetCheck): string {
  return [
    ...
    '   To increase the budget, edit max_cost_per_review in sifthookdev.config.json.',
    '━'.repeat(50),
    '',
  ].join('\n');
}
